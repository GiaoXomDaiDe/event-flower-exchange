        ...
        <div className='cart-body'>
          {cart?.length > 0 ? (
            ...
            <div className='cart-body_empty'>
              <img className='cart-body_img' src={assets.emptyCart} alt='emptyCart' />
              <h1>Empty Cart</h1>
            </div>
          )}
        </div>
...
const CartItem = ({ item, handleUpdateCart, handleDeleteCart, handleRadioOption }) => {
...
CartItem.propTypes = {
  ...
  handleRadioOption: PropTypes.func.isRequired
}
