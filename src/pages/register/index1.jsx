...
function RegisterPage() {
  ...
  const handleRegister = async () => {
    try {
      ...
      formRegister.append('Birthday', birthday.format('YYYY-MM-DD') ? birthday.format('YYYY-MM-DD') : '')
      ...
      const response = await axios.post('https://localhost:7026/api/account/register', formRegister, {
        headers: {
      ...
      <div className='register_form'>
        ...
        <Form onFinish={handleRegister}>
          ...
          <Form.Item name='Gender'>
            <Select placeholder='Gender' value={gender} onChange={(value) => setGender(value)}>
