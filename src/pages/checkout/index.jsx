                ...
                <div className={cx('checkout-input')}>
                  ...
                  <div className={cx('checkout-delivery')}>
                    ...
                    <div className={cx('checkout-delivery_address')}>
                      <Form.Item name='province' rules={[{ required: true, message: 'Please select a province!' }]}>
                        <Select
                      ...
                      <Form.Item name='district' rules={[{ required: true, message: 'Please select a district!' }]}>
                        <Select
                      ...
                      <Form.Item name='ward' rules={[{ required: true, message: 'Please select a ward!' }]}>
                        <Select
                      ...
                      >
                        <Input placeholder='Number Address and Street' onChange={handleNumberAddress} size='large' />
                      </Form.Item>
                    </div>
                  </div>
